...
def loginuser():
        ulab.grid(row =2, column=3)
        uname.grid(row=3,column=3)
        ulab1.grid(row =4, column=3)
        upass.grid(row=5,column=3)
        log.grid(row=6,column=3)

def loginOrg():
    ulab2.grid(row =8, column=3)
    uname1.grid(row=9,column=3)
    ulab3.grid(row =10, column=3)
    upass1.grid(row=11,column=3)
    log1.grid(row=12,column=3)
...
ddp = Label(root, text="DDP").grid(row =0, column=1)
B1 = Button(root, text ="Login as user", command = loginuser).grid(row=1,column=3)
ulab = Label(root, text="Username")
ulab.grid_remove
uname= Entry(root, bd =5)
uname.grid_remove
ulab1 = Label(root, text="Password")
ulab1.grid_remove
upass= Entry(root, bd =5)
upass.grid_remove
log = Button(root, text ="Login", command = textEdit)
log.grid_remove
B2 = Button(root, text ="Login as organisation", command = loginOrg).grid(row=7,column=3)
ulab2 = Label(root, text="Username")
ulab2.grid_remove
uname1= Entry(root, bd =5)
uname1.grid_remove
ulab3 = Label(root, text="Password")
ulab3.grid_remove
upass1= Entry(root, bd =5)
upass1.grid_remove
log1 = Button(root, text ="Login", command = textEdit)
log1.grid_remove
