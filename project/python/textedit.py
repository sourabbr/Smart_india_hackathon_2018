...
class Editor():
    def __init__(self, root):
        ...
        filemenu.add_command(label="Run", underline=1, command=self.file_run, accelerator="Ctrl+R")
    ...
    def file_run(self,event=None):
       ...
       # print(str1)
        ...
        if IPAddress("192.168.0.224") in IPNetwork("192.168.0.0/24"):
            pyAesCrypt.decryptFile('/home/supriya/SIH/python/organization/data.csv.aes', "../datafile2.csv", final_secret_key, bufferSize)
